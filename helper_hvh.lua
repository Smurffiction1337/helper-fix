...
-- saving optimized by dev
--[[Original Code by sapphyrus]]--
-- enhanced by dev, baka
-- update 11/9/2020
...
M = {}
surface_native = {
 native_Surface_DrawSetColor 				= vmt_bind("vguimatsurface.dll", "VGUI_Surface031", 15, "void(__thiscall*)(void*, int, int, int, int)"),
 native_Surface_DrawFilledRect 			= vmt_bind("vguimatsurface.dll", "VGUI_Surface031", 16, "void(__thiscall*)(void*, int, int, int, int)"),
 native_Surface_DrawOutlinedRect 		= vmt_bind("vguimatsurface.dll", "VGUI_Surface031", 18, "void(__thiscall*)(void*, int, int, int, int)"),
 native_Surface_DrawLine 						= vmt_bind("vguimatsurface.dll", "VGUI_Surface031", 19, "void(__thiscall*)(void*, int, int, int, int)"),
 native_Surface_DrawPolyLine 				= vmt_bind("vguimatsurface.dll", "VGUI_Surface031", 20, "void(__thiscall*)(void*, int*, int*, int)"),
 native_Surface_DrawSetTextFont 			= vmt_bind("vguimatsurface.dll", "VGUI_Surface031", 23, "void(__thiscall*)(void*, unsigned long)"),
 native_Surface_DrawSetTextColor 		= vmt_bind("vguimatsurface.dll", "VGUI_Surface031", 25, "void(__thiscall*)(void*, int, int, int, int)"),
 native_Surface_DrawSetTextPos 			= vmt_bind("vguimatsurface.dll", "VGUI_Surface031", 26, "void(__thiscall*)(void*, int, int)"),
 native_Surface_DrawPrintText 				= vmt_bind("vguimatsurface.dll", "VGUI_Surface031", 28, "void(__thiscall*)(void*, const wchar_t*, int, int)"),
 native_Surface_DrawGetTextureId 		= vmt_bind("vguimatsurface.dll", "VGUI_Surface031", 34, "int(__thiscall*)(void*, const char*)"),
 native_Surface_DrawGetTextureFile 	= vmt_bind("vguimatsurface.dll", "VGUI_Surface031", 35, "bool(__thiscall*)(void*, int, char*, int)"),
 native_Surface_DrawSetTextureFile 	= vmt_bind("vguimatsurface.dll", "VGUI_Surface031", 36, "void(__thiscall*)(void*, int, const char*, int, bool)"),
 native_Surface_DrawSetTextureRGBA 	= vmt_bind("vguimatsurface.dll", "VGUI_Surface031", 37, "void(__thiscall*)(void*, int, const wchar_t*, int, int)"),
 native_Surface_DrawSetTexture 			= vmt_bind("vguimatsurface.dll", "VGUI_Surface031", 38, "void(__thiscall*)(void*, int)"),
 native_Surface_DeleteTextureByID 		= vmt_bind("vguimatsurface.dll", "VGUI_Surface031", 39, "void(__thiscall*)(void*, int)"),
 native_Surface_DrawGetTextureSize 	= vmt_bind("vguimatsurface.dll", "VGUI_Surface031", 40, "void(__thiscall*)(void*, int, int&, int&)"),
 native_Surface_DrawTexturedRect 		= vmt_bind("vguimatsurface.dll", "VGUI_Surface031", 41, "void(__thiscall*)(void*, int, int, int, int)"),
 native_Surface_IsTextureIDValid 		= vmt_bind("vguimatsurface.dll", "VGUI_Surface031", 42, "bool(__thiscall*)(void*, int)"),
 native_Surface_CreateNewTextureID 	= vmt_bind("vguimatsurface.dll", "VGUI_Surface031", 43, "int(__thiscall*)(void*, bool)"),
 ...
 native_Surface_SetFontGlyph 				= vmt_bind("vguimatsurface.dll", "VGUI_Surface031", 72, "void(__thiscall*)(void*, unsigned long, const char*, int, int, int, int, unsigned long, int, int)"),
 native_Surface_GetTextSize 					= vmt_bind("vguimatsurface.dll", "VGUI_Surface031", 79, "void(__thiscall*)(void*, unsigned long, const wchar_t*, int&, int&)"),
 native_Surface_GetCursorPos 				= vmt_bind("vguimatsurface.dll", "VGUI_Surface031", 100, "unsigned int(__thiscall*)(void*, int*, int*)"),
 native_Surface_SetCursorPos					= vmt_bind("vguimatsurface.dll", "VGUI_Surface031", 101, "unsigned int(__thiscall*)(void*, int, int)"),
 native_Surface_DrawOutlinedCircle 	= vmt_bind("vguimatsurface.dll", "VGUI_Surface031", 103, "void(__thiscall*)(void*, int, int, int, int)"),
 native_Surface_DrawFilledRectFade 	= vmt_bind("vguimatsurface.dll", "VGUI_Surface031", 123, "void(__thiscall*)(void*, int, int, int, int, unsigned int, unsigned int, bool)"),
}
font_cache = {}
...
function M.create_font(windows_font_name, tall, weight, flags)
	...
	if font_cache[cache_key] == nil then
		...
		surface_native.native_Surface_SetFontGlyph(font_cache[cache_key], windows_font_name, tall, weight, 0, 0, bit.bor(flags_i), 0, 0)
	end
...
local silent_enabled_reference = ui.new_combobox("LUA", "B", "Automatic release", "Legit (Silent)", "Legit (Smooth)", "Rage")
local silent_dist = ui.new_slider("LUA", "B", "Silent Distance", 0, 25, 15, true)
local legit_smooth_dist = ui.new_slider("LUA", "B", "Smooth Distance", 0, 15, 5, true)
...
ui.set_callback(silent_enabled_reference, function(c)
	ui_set_visible(silent_dist, (ui_get(c) == "Rage"))
	ui_set_visible(legit_smooth_dist, (ui_get(c) == "Legit (Smooth)"))
	ui_set_visible(legit_smooth_fact, (ui_get(c) == "Legit (Smooth)"))
end)
...
local function on_enabled_changed()
	...
	ui_set_visible(silent_dist, enabled and (ui_get(silent_enabled_reference) == "Rage"))
	ui_set_visible(legit_smooth_dist, enabled and (ui_get(silent_enabled_reference) == "Legit (Smooth)"))
	ui_set_visible(legit_smooth_fact, enabled and (ui_get(silent_enabled_reference) == "Legit (Smooth)"))
...
local function on_saving_export(c)
	...
	if saving_location ~= nil then
		...
		if ui.name(c) == "  Save  " then
			...
			writefile('mydata.json', mydata ~= nil and (string.sub(mydata, 1, -2)..","..json_str..']') or '['..json_str..']')
			client_log("Saved spot to mydata.json")
			package_loaded["helper_data"] = nil
...
local saving_import_reference = ui.new_button("LUA", "B", "  Import  ", function()
	...
	if clipboard_text_length > 0 then
		...
		if ifSucc then
			local mydata = readfile('mydata.json')
			writefile('mydata.json', mydata ~= nil and (string.sub(mydata, 1, -2)..","..clipboard_data..']') or '['..clipboard_data..']')
		end
	end
end)
...
function on_saving_enabled_changed()
	...
	ui_set_visible(saving_update_file_reference, saving_enabled)
					...
					for i=1, #data_map do
						...
						if (weapon == location.weapon or (weapon == "weapon_wallbang" and location.weapon == "weapon_wallbang_light")) and table_contains(types_enabled, location.type) and (location.tickrate == nil or location.tickrate == tickrate or true) and (not location.temporary or saving_enabled) then
							if location.name == nil then
								...
								location.name = shorten_name and split_localize(location.to) or (split_localize(location.from) .. " to " .. split_localize(location.to))
							end
...
local function on_setup_command(cmd)
	...
	if hotkey or helper_recreate_dynamic.active then
		local silent_enabled = ui_get(silent_enabled_reference) ~= "Legit (Smooth)" or helper_recreate_dynamic.active
...
local function on_paint()
	...
	for pos, text in pairs(pos_width) do
		...
		M.draw_filled_rect(pos.wx-width/2, pos.wy-height+7, width, height, background_r, background_g, background_b, background_a*pos.world_alpha_multiplier*a_mp)
	...
	for i=1, #locations_close do
		...
		if location.text_world ~= nil then
			...
			M.draw_text(location.pos.wx - textw/2, location.pos.wy-10*location.offset - texth/2, r, g, b, a*location.pos.world_alpha_multiplier*a_mp, SFont, location.text_world)
		end
	end
	...
	if location_closest ~= nil and location_closest.target.wx ~= nil then
		...
		local closest_targeted = ((ui_get(silent_enabled_reference) == "Legit (Silent)" and location_closest.type == "grenade") and (location_targeted.crosshair_dist <= location_closest.viewAnglesDistanceMax) or location_targeted.viewangles_correct) and entity_get_prop(local_player, "m_flDuckAmount") == (location_closest.duck and 1 or 0)
		if ui_get(silent_enabled_reference) == "Rage" then
			closest_targeted = ((ui_get(silent_enabled_reference) == "Rage" and location_closest.type == "grenade") and (location_targeted.crosshair_dist < ui_get(silent_dist)) or location_targeted.viewangles_correct) and entity_get_prop(local_player, "m_flDuckAmount") == (location_closest.duck and 1 or 0)
		end
		...
		if ui_get(silent_enabled_reference) == "Legit (Smooth)" then
			closest_targeted = ((ui_get(silent_enabled_reference) == "Legit (Smooth)" and location_closest.type == "grenade") and (location_targeted.crosshair_dist <= location_closest.viewAnglesDistanceMax) or location_targeted.viewangles_correct) and entity_get_prop(local_player, "m_flDuckAmount") == (location_closest.duck and 1 or 0)
			...
			if not closest_targeted and ui_get(hotkey_reference) and location_targeted.crosshair_dist < ui_get(legit_smooth_dist) then
				local pitch, yaw = client_camera_angles()
				client_camera_angles(pitch + clamp_angles(location_closest.pitch - pitch) / ui_get(legit_smooth_fact), yaw + clamp_angles(location_closest.yaw - yaw) / ui_get(legit_smooth_fact))
			end
		end
		...
		for i=1, #locations_on do
			...
			if location.target.wx ~= nil then
				...
				M.draw_filled_rect(location.target.wx-7, location.target.wy-6, width+16, height+3, background_r, background_g, background_b, background_a*a_mp*a_mp_target)
		...
		for i=1, #locations_on do
			...
			if location.target.wx ~= nil then
				...
				M.draw_text(location.target.wx+6, location.target.wy-6, r, g, b, a*a_multiplier*a_mp*a_mp_target, SFont, location.target_text)

				if location.target_text_2 ~= nil then
					M.draw_text(location.target.wx+6+location.target_text_width, location.target.wy-6, 200, 200, 200, 255*a_multiplier*0.8*a_mp*a_mp_target, SFont, location.target_text_2)
				end
